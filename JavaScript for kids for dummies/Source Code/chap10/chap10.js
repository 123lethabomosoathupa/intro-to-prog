...
function replaceIt() {
    ...
    var theStory = "<h1>Lethabo's Dance Party</h1>";
    theStory += "One " + adj1 + " day, Lethabo was " + verbIng + " in his " + roomInHouse + ", reading a book about " + color + " " + nounPlural + ".<br><br>";
    ...
    theStory += "Lethabo danced the " + animal + " Dance, the " + city + " Shake, and took the prize for dancing the best Electric " + verb + ".<br><br>";
